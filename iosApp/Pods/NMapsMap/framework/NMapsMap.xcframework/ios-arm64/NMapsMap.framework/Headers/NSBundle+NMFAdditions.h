...
/**
 SDK의 모든 네트워크 요청에 사용하는 User-Agent 문자열을 반환한다.
 형식: NaverMapSDK/{sdkVersion} ({osName} {osVersion}; {deviceModel}; {appBundleId} {appVersion})
 */
+ (nonnull NSString *)naverMapUserAgent;
